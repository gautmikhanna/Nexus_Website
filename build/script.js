...
const load = async (page, isReload = false, direction = "left") => {
  ...
  fetch("./content/" + pages[page] + ".html").then((response) => response.text()).then((data) => {
    mid_data = data;
  });
  fetch("./content/" + pages[next_slide] + ".html").then((response) => response.text()).then((data) => {
    right_data = data;
  });
  fetch("./content/" + pages[previous_slide] + ".html").then((response) => response.text()).then((data) => {
    left_data = data;
    if (isReload) {
